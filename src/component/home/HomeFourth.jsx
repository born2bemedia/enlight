      ...
      <div className="_container">
        <div className="home-fourth__body">
          ...
          <RevealWrapper origin="bottom" delay={0}>
            <h2>
            Break free from outdated <br/>marketing techniques that drain <br/>your budget with little return. 
            </h2>
          </RevealWrapper>
          <RevealWrapper origin="bottom" delay={0}>
            <p>Transform your strategy with Enlight and unlock better results tomorrow. </p>
          </RevealWrapper>
