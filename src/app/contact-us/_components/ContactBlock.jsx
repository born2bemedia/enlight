    ...
    <section className="contact-block">
      <div className="_container">
        <RevealWrapper origin="bottom" delay={0}>
          <h1>
            Connect with crypto <br />
            marketing experts
          </h1>
        </RevealWrapper>
        <RevealWrapper origin="bottom" delay={0}>
          <h3>To supercharge the growth of your crypto project.</h3>
        </RevealWrapper>
        <RevealList
          origin="bottom"
          interval={0}
        ...
        >
          <div className="contact-left">
            <h2>
              Connect, collaborate, and boost your crypto project's visibility
            ...
            <div className="contact-tabs">
              <div className="tabs-head">
                <div
                  className={`tab-title ${tab == "tab1" ? "active" : ""}`}
                ...
                <div
                  className={`tab-title ${tab == "tab2" ? "active" : ""}`}
              ...
              <div className="tabs-content">
                <div className={`tab ${tab == "tab1" ? "active" : ""}`}>
                  <p>
                ...
                <div className={`tab ${tab == "tab2" ? "active" : ""}`}>
                  <p>138 Gloucester Rd, Wan Chai, Hong Kong</p>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.963618174847!2d114.17469511083856!3d22.279367958624526!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3404005bcddccfe3%3A0x1e4dc41e1016e82e!2sAllied%20Kajima%20Building%2C%20138%20Gloucester%20Rd%2C%20Wan%20Chai%2C%20Hong%20Kong!5e0!3m2!1sen!2sua!4v1713946963836!5m2!1sen!2sua"
                    width="600"
                    height="450"
                    allowfullscreen=""
                    loading="lazy"
